defmodule Saxaboom do
  ...
  def handle_event(
    ...
    handler_definition =
      current_handler.__struct__.__element_definition__(current_handler, current_element)
  ...
  def handle_event(
    ...
    current_handler =
      current_handler.__struct__.__cast_element__(current_handler, current_element)
